...
describe("MagicalCharacter", () => {
  ...
  test("Проверяем геттер и сеттре distance", () => {
    ...
    expect(() => magician.distance = -1).toThrow("Расстояние должно быть от 1 до 5 клеток")
    expect(() => magician.distance = 0).toThrow("Расстояние должно быть от 1 до 5 клеток")
    expect(() => magician.distance = 6).toThrow("Расстояние должно быть от 1 до 5 клеток")
    daemon.distance = 2
